...
foreach($astronauta as $linha){
    if($campo == "astronauta_nave"){
        ...
        echo "<div class='titulo'><a href='index.php?pagina=astronautas/view_listar_astronautas&campo=astronauta_nave&valor=$nave'>".$linha['astronauta_nave']."</a></div>";
    ...
    if($campo == "astronauta_pais"){
        ...
        echo "<div class='campo'><div class='titulo'><a href='index.php?pagina=astronautas/view_listar_astronautas&campo=astronauta_pais&valor=$pais'>".$linha['astronauta_pais']."</div><img width=100px height=50px src='img/flags/$img.png'></a></div>";
    }
}
echo "</div>";
